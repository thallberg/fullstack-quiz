  ...
  const loadQuizzes = async () => {
    try {
      ...
      if (errorMessage.includes('400') || errorMessage.includes('Bad Request')) {
        // Behandla som att inga quiz finns
        setQuizzes([]);
        setError('');
      } else {
    ...
    return (
      <div className="p-8 text-center">
          <div className="mb-4">
            ...
            <p className="text-gray-600 text-base">Börja skapa ditt första quiz för att komma igång!</p>
          </div>
          <Button
            variant="primary"
    ...
    return (
      <div className="p-8 text-center">
          <div className="mb-4">
            ...
            <p className="text-red-600 text-lg font-semibold mb-2">Kunde inte ladda dina quiz</p>
