...
export function LeaderboardSection() {
  ...
  const totalQuizzes = leaderboard.myQuizzes.length + leaderboard.friendsQuizzes.length + leaderboard.publicQuizzes.length;
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Publika Quiz Leaderboard */}
      {Array.isArray(leaderboard.publicQuizzes) && leaderboard.publicQuizzes.length > 0 && (
        <Collapsible
          title={
            <span className="flex items-center gap-2">
              Publika Quiz Leaderboard
              <Badge variant="default" className="text-xs">
                {leaderboard.publicQuizzes.length} {leaderboard.publicQuizzes.length === 1 ? 'quiz' : 'quiz'}
              </Badge>
            </span>
          }
        ...
        >
          <div className="space-y-4 sm:-mx-2 lg:-mx-4">
            {leaderboard.publicQuizzes.map(renderQuizLeaderboard)}
          </div>
        </Collapsible>
      )}
    </div>
