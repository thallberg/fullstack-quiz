...
export function MyLeaderboardScreen() {
    ...
    <ProtectedRoute onRedirectToLogin={() => navigation.replace('Login')}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.container}>
        <View style={styles.header}>
          <Text style={styles.title}>Min leaderboard</Text>
          <Text style={styles.subtitle}>Resultat från dina quiz</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '700', color: colors.yellow, marginBottom: 6 },
